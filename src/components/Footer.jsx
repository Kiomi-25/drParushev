          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-[#00A79D] mr-3 mt-0.5 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
              ...
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 text-[#00A79D] mr-3 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 hover:bg-[#0071BB] rounded-full flex items-center justify-center transition-all hover:scale-110"
                aria-label="Facebook">
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
