...
export const LanguageProvider = ({ children }) => {
    ...
    const translations = {
        BG: {
         ...
         aboutTitle: "За мен",
         aboutParagraph1: "Завърших средното си образование завърших в Испанската гимназия в София. Дипломирах се през 2016 с магистърска степен по дентална медицина в София.",
         aboutParagraph2: "Интересите ми са насочени в областта на ендодонтията, естетични реставрации и алайнери. Посещавам множество квалификационни курсове в България и чужбина, по този начин се стремя да следя тенденциите в денталната медицина и да ги прилагам в практиката си.",
         aboutParagraph3: "От 2016 до 2018 работих в дентална практика в Люлин. В края на 2018 година стартирах своя собствена, която ръководя от тогава. Интересите ми извън стоматологията са свързани с планински преходи.",
      ...
      importantInfoText: "*Лечебният план и посочените цени в него за манипулациите са актуални 6 месеца от датата на получаването",
      ...
      casesTitle: "Случаи",
      casesSubtitle: "Разгледайте някои от успешните ни случаи - преди и след лечение",
      caseAlt: "Случай",
      ...
      gallerySubtitle: "Разгледайте нашата модерна дентална практика и оборудване",
      galleryAlt: "Галерия",
      ...
      contactMapTitle: "Дентална практика Д-р Парушев",
       ...
       bookingSubtitle: "Попълнете формата и ние ще се свържем с Вас възможно най-скоро",
       ...
       bookingMessagePlaceholder: "Опишете Вашия проблем и желан ден за преглед...",
      ...
      footerDescription: "Съвременна дентална грижа с индивидуален подход. Специализирани услуги в ендодонтия, естетични реставрации и алайнери.",
      ...
      footerTerms: "Общи условия",
        ...
        EN: {
            ...
            // About section translations
           aboutTitle: "About Me",
           aboutParagraph1: "I completed my secondary education at the Spanish High School in Sofia. I graduated in 2016 with a master's degree in dental medicine in Sofia.",
           aboutParagraph2: "My interests are focused in the field of endodontics, aesthetic restorations and aligners. I attend numerous qualification courses in Bulgaria and abroad, thus striving to follow the trends in dental medicine and apply them in my practice.",
           aboutParagraph3: "From 2016 to 2018 I worked in a dental practice in Lyulin. At the end of 2018, I started my own practice, which I have been managing since then. My interests outside of dentistry are related to mountain hiking.",
      ...
      services: [
        {
          title: "Prevention",
          description: "Regular check-ups and cleaning for healthy teeth and gums"
        },
        {
      ...
      pricesSubtitle: "Transparent and affordable prices for quality dental care",
      currency: "BGN",
      ...
      importantInfoText: "*The treatment plan and the prices indicated in it for the procedures are valid for 6 months from the date of receipt",
      ctaButton: "Book an Examination",

       // Cases section translations
       casesPortfolio: "Portfolio",
       casesTitle: "Cases",
       casesSubtitle: "View some of our successful cases - before and after treatment",
       caseAlt: "Case",
      ...
      bookingSubtitle: "Fill out the form and we will contact you as soon as possible",
      ...
      bookingMessagePlaceholder: "Describe your problem and desired appointment date...",
      ...
      footerDescription: "Modern dental care with an individual approach. Specialized services in endodontics, aesthetic restorations and aligners.",
      ...
      footerTerms: "Terms and Conditions",
        ...
        return (
            <LanguageContext.Provider value={{ currentLang, toggleLanguage, translations: translations[currentLang] }}>
              {children}
